                    ...
                    <div class="card-body" style="height: auto;background: black">
                        <div id="contact-form">
                            <form method="post" action=""
                                ...
                                <span class="required">${form.name}</span><br>
                            <c:forEach items="${eles}" var="i">
                                <c:if test="${i.formname == form.name}">
                                    <tr><th> <span class="required">${i.name}</span></th><<br>
                                        <input type="text"  name="name" required="required" tabindex="1" autofocus="autofocus"><br></tr>
                                </c:if>
                            </c:forEach>
                            </form>
                        </div>
