            ...
            <div class="col-md-12 col-lg-12 col-sm-12">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <li><a href="${pageContext.request.contextPath}/">unicorn </a></li>
                        <li class="active">Element_LIst</li>
                    </div>

                    <div class="card-body" style="height: auto;background: black">
                        ...
                        <div id="contact-form" >
                            <form method="post" action="${pageContext.request.contextPath}/FormUpdate.do" >
                                ...
                                <input type="text" name="publish" value="${form.publish}" required="required" tabindex="1" autofocus="autofocus"><br>
                                <span class="required">所属栏目</span><br>
                                <select name="categoris" value="${form.categoris}" id="subject">
