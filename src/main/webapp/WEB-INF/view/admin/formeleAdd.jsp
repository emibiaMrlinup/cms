                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body" style="height: auto;background: black">
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/FormeleAdd.do"
                            ...
                            <input type="text" name="name" required="required" tabindex="1" autofocus="autofocus">
                            <br>

                            <span class="required">所属表单</span><br>
                            <select name="formname" required="required" tabindex="1" autofocus="autofocus" id="subject">
                            <option value="" tabindex="4"  >==请选择==</option>
