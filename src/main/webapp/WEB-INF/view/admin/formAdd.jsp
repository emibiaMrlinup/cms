                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body" style="height: auto;background: black">
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/FormAdd.do"
                            ...
                            <input type="text" name="name" required="required" tabindex="1" autofocus="autofocus"><br>
                            <span class="required">发布者:</span><br>
                            <input type="text" name="publish" required="required" tabindex="1" autofocus="autofocus"><br>
                            <span class="required">所属栏目</span><br>
                            <select name="categoris" id="subject">
                            <option value="">==请选择==</option>
                            <c:forEach items="${cates}" var="i">
                                <option value="${i.name}" >${i.name}</option>
                            </c:forEach>
                        </select><br>
                            所属文章<select name="articles"><br>
                            <option value="">==请选择==</option>
