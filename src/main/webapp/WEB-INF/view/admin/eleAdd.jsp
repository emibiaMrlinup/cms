                    ...
                    <div class="card-body" style="background: black">
                        <div id="contact-form">
                            <form method="post" action="${pageContext.request.contextPath}/eleAdd.do"
                                ...
                                <span class="required">命名:</span><br><input type="text" name="name" required="required" tabindex="1" autofocus="autofocus"><br>
                                <span class="required">所属表单:</span><br><input type="text" name="formname" value="${forms.name}" readonly required="required" tabindex="1" autofocus="autofocus"><br>
